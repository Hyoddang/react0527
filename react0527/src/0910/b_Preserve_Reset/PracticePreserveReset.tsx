...
// 버튼을 눌러도 입력된 테스트가 초기화 되지 않도록 수정
// 텍스트 상태를 보존
...
export default function PracticePreserveReset() {
  const [showHint, setShowHint] = useState<boolean>(false);

  return (
    <div>
      {/* Form 컴포넌트의 위치를 일관적으로 두 번째 자식 위치에 유지시키고 싶은 경우: showHint가 null일 때도 null을 직접적으로 작성해야 한다 */}
