...
export default function Tsx01() {
  return (
    ...
    */}
    ...
    {/* 리액트에서 class는 예약어로 사용되기 때문에 Dom 속성에 있는 className으로 사용 */}
    <div className='camelCase' style={{ backgroundColor: 'grey' }}>카멜케이스를 사용하세요!</div>
    {/* //! 5. 주석 */}
    {/* 
    HTML 주석을 중괄호 안에서 작성 
    중괄호 안에 작성 안 할경우 화면에 나타남.
    */}
    </>
  )
}
