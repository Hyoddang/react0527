...
// 배치 처리
// : React기 UI에 있는 이벤트 핸들러와 그 안의 모든 코드가 완료될 때까지
// : 업데이트 되지 않는다는 것을 의미
  ...
  return (
    <>
      ...
      <button onClick={() => {
        ...
        // 업데이터 함수 네이밍 규칙
        // : 함수 인수의 이름은 해당 상태변수의 첫 글자로 짓는 것이 일반적
      ...
      <h1>{number2}</h1>
      <button onClick={() => {
      // number2가 0이므로 아래 작업에서 React는 렌더링 목록에(큐)에 "5로 교체" 추가
