...
// 카운터의 수를 useState로 상태관리 [count, setCount]
// 버튼을 클릭할 때 마다 카운터의 값을 1씩 증가 handleClick 함수
// button태그에 handleClick 함수를 사용
// : 위 요소의 내용으로는 count 상태 변수를 출력
// : 클릭한 횟수: 3회
...
// Ex) 타임아웃 ID 저장
//     DOM요소를 저장하고 조작, JSX(TSX)를 계산하는데 필요하지 않은 기타 객체 저장

//! ref를 잘 사용하는 방법
// - React 상태의 제한 사항은 ref에 적용되지 X
// - ref는 현재 값을 변형하면 즉시 변경되기 때문에 상태의 로직과 데이터 흐름을 고려하여 작성
