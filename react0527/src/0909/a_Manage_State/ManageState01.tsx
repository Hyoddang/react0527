...
// 빈 상태: 비활성화 된 '제출' 버튼 존재
// 입력 중: 활성화된 '제출' 버튼 존재
// 제출 중: 완전히 비활성화 > 스피너가 표시
// 성공: 양식 대신 '성공!' 메시지 표시
// 오류: 입력 중 상태와 동일하지만 추가 오류 메시지 표시
...
//* 4. 필수적이지 않은 상태 변수 제거하기
// 필수적이지 않은 상태가 충돌되는지 여부
// Ex) isTyping isSubmitting이 동시에 참일 수 있는가?
...
const [status, setStatus] = useState<'typing' | 'submitting' | 'success'>('typing');
  ...
  return (
    <>
      <h2>City Quiz</h2>
      <p>In which city is there a billboard that turns air into drunkable water?</p>
